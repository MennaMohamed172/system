...
const NavBar = () => {
    ...
    return (
    <>    
        <nav className="bg-red  dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4" style={{backgroundColor:"#c9dcff"}}>
            <Link href="/" className="flex items-center">
                <img src="/images/elmrooj2.png" className="h-8 mr-3" alt="Company Logo" style={{width:"90px", height:"90px" , borderRadius:"50%"}} />
                <span className="self-center text-xl font-semibold whitespace-nowrap">El-mrooj</span>
            </Link>
